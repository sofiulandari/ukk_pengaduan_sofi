            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/pengaduan/store" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Foto</label>
                            <input type="file" name="foto" class="form-control" id="inputGroupFile" placeholder="foto">
                        ...
                        <div class="form-group">
                            <label>Status</label>
                            <br>
                            <input type="text" name="status" value="Proses" class="form-control" placeholder="foto">
                            </br>
